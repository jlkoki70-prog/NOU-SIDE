...
const lpSections: LPSection[] = [
  ...
  },
  {
    ...
    accordionLabel: "合意形成のポイントを詳しく見る",
    accordionItems: [
      { title: "誰の仕事でもない課題は、関係者が話し合う場が必要（協議の場づくり）", image: "/images/lp/section5-accordion-community-discussion.webp", imageAlt: "農家・組合・自治体それぞれが単独では動かしにくい課題を、本音で話し合う地域協議の場が合意形成と実行につなげることを示す図" },
      { title: "実行する当事者を議論に入れることが大切（参加者の選定）", image: "/images/lp/section5-accordion-nextgen-consensus.webp", imageAlt: "当事者不在の議論と次世代が入る協議の比較図。次世代に選ばれる地域は、当事者を交えた建設的な協議ができる。" },
